		...
		<div class="relative w-full max-w-md">
			...
			<div class="bg-slate-950/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
				...
				<div class="flex items-center gap-3 my-6">
					...
					<span class="text-xs text-slate-500 uppercase tracking-wider">{{ $t('common.or') }}</span>
					<div class="flex-1 h-px bg-white/10"></div>
				</div>

				<!-- Google Login (admin) -->
				<button @click="loginWithGoogle" type="button" :disabled="loading"
					class="w-full flex items-center justify-center gap-3 py-3 px-4 border border-white/10 rounded-xl bg-white/5 text-white hover:bg-white/10 transition-all text-sm font-medium disabled:opacity-50">
