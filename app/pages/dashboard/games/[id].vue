...
const game = ref({
	...
	prizeRedemptionDelayEnabled: true,
	prizeRedemptionDelayHours: 24,
					...
					<div
						...
						<form v-show="activeTab === 'appearance'" @submit.prevent="saveGame" class="space-y-6">
							...
							<div class="mt-6 pt-6 border-t border-slate-100 dark:border-slate-700">
								...
								<!-- Tabs -->
								<div class="flex gap-1.5 mb-4 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg w-fit border border-slate-200/60 dark:border-slate-700">
									<button type="button" @click="bgTab = 'themes'"
										...
										:class="bgTab === 'themes' ? 'bg-blue-600 text-white shadow-sm' : 'bg-white/80 dark:bg-slate-700/80 text-slate-600 dark:text-slate-300 font-semibold shadow-sm hover:bg-white hover:text-slate-900'">
										<Icon name="ph:paint-bucket-bold" size="14" />
										{{ $t('games.detail.background_themes') }}
									</button>
									<button type="button" @click="bgTab = 'image'"
										class="px-4 py-2 rounded-md text-sm font-medium transition-all flex items-center gap-2"
										:class="bgTab === 'image' ? 'bg-blue-600 text-white shadow-sm' : 'bg-white/80 dark:bg-slate-700/80 text-slate-600 dark:text-slate-300 font-semibold shadow-sm hover:bg-white hover:text-slate-900'">
